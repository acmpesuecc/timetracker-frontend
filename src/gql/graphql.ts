...
export type GetSheetInfoQuery = { __typename?: 'Query', Sheet?: { __typename?: 'SheetInfo', hasEnded: boolean, total: number, summary: { __typename?: 'Sheet', name: string, id: string }, records: Array<{ __typename?: 'NRecord', event: EventType, id: string, time: number }> } | null };
...
export type CreateSheetMutationVariables = Exact<{
  sheetName: Scalars['String'];
  month: Scalars['Int'];
  year: Scalars['Int'];
}>;
...
export type CreateSheetMutation = { __typename?: 'Mutation', Sheet?: string | null };
...
export const CreateSheetDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateSheet"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"sheetName"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"month"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"year"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"Sheet"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"sheetName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"sheetName"}}},{"kind":"Argument","name":{"kind":"Name","value":"Month"},"value":{"kind":"Variable","name":{"kind":"Name","value":"month"}}},{"kind":"Argument","name":{"kind":"Name","value":"Year"},"value":{"kind":"Variable","name":{"kind":"Name","value":"year"}}}]}]}}]} as unknown as DocumentNode<CreateSheetMutation, CreateSheetMutationVariables>;